...
Dr. J wins on average $16.38 when he plays the game.
...
cat("FairBet=",FairBet)                          
```
To make the bet fair, Dr.J should pay up to $4.40.
...
cat("AverageWin=",EV)
```
For a class size of 27 with 20 students betting, Dr.J's profit would be $5.17



For a class size of 23 $1 to $1 is fair.
